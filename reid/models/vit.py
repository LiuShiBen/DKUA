...
class TransReID(nn.Module):
    ...
    def forward_features(self, x, register_blk=-1, prompt=None, image_query=None, text_prompt = None):
        B = x.shape[0]
    ...
    def forward(self, x, register_blk=-1, prompt=None, image_query=None, text_prompt = None):
        x = self.forward_features(x, register_blk=register_blk, prompt = prompt, image_query=image_query, text_prompt=text_prompt)
        return x
